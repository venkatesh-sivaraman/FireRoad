...
class CourseManager: NSObject {
    ...
    func markCourseAsRecentlyViewed(_ course: Course) {
        if let index = recentlyViewedCourses.firstIndex(of: course) {
    ...
    func markCourseAsFavorite(_ course: Course) {
        if favoriteCourses.firstIndex(of: course) != nil {
            return
        }
    ...
    func markCourseAsNotFavorite(_ course: Course) {
        if let index = favoriteCourses.firstIndex(where: { $0.subjectID == course.subjectID }) {
    ...
    func setCustomCourse(_ course: Course) {
        ...
        if let index = customCourseCache.firstIndex(where: { $0.subjectID == course.subjectID && $0.subjectTitle == course.subjectTitle }) {
